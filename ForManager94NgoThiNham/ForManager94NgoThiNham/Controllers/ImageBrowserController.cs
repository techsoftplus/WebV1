...
namespace ForManager94NgoThiNham.Controllers
{
    ...
    public class ImageBrowserController : Controller
    {
        ...
        private const string PrettyName = "Uploads/Articles";
        ...
        [OutputCache(Duration = int.MaxValue, VaryByParam = "path")]
        ...
        public virtual ActionResult Destroy(string path, string name, string type)
        {
            ...
            throw new HttpException("Vui lòng liên hệ với Administrators để xóa");
